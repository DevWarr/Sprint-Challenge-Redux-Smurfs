...
Demonstrate your understanding of this Sprint's concepts by answering the following free-form questions located in `Answers.md`.
...
- [x] Retrieve an array of all the Smurfs in the Smurf DB by writing a `GET` to the endpoint `/smurfs`.
